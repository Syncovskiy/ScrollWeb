...
<p align="center">
  <a href="https://github.com/Syncovskiy/ScrollWeb/releases/download/v1.0.1/ScrollWeb.mp4">
    <img src="https://github.com/Syncovskiy/ScrollWeb/releases/download/v1.0.1/ScrollWeb-demo.gif" alt="ScrollWeb animated demo" width="100%">
  </a>
</p>

GIF проигрывается прямо в README. Нажмите на него, чтобы открыть MP4: [ScrollWeb.mp4](https://github.com/Syncovskiy/ScrollWeb/releases/download/v1.0.1/ScrollWeb.mp4).
